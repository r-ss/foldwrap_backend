...
class AppConfig(BaseSettings):
    ...
    #     "regex": r"\A[\w\-\.]{3,16}\Z",
    #     "failmessage": "Username must be at least 3 characters and may contain . - _ chars.",
    # }  # also can be used as hint
    AUTH_PASSWORD_REGEX: dict = {
        "regex": r"\A[\w\-\.]{6,}\Z",
        "failmessage": "Password must at least 6 characters and may contain . - _ symbols",
    }  # also can be used as hint
